        ...
        <div className="w-full flex items-center justify-between p-6 space-x-6">
            <div className='flex-1 truncate'>
                <div className="flex items-center space-x-3">
                    <h3 className='text-gray-900 text-sm font-medium trucate'>{product.name}</h3>
                    <span className='flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs bg-green-200 rounded-full'>
